...
from ridge_toolkitNOID import GetProblematicSources
import RLConstantsMK as RLC
...
def CreatePositionTable(source_list, available_sources, lofar_table):
    ...
    """
    ***
    NOT NEEDED FOR MEERKAT AND WILL NOT WORK
    ***
        ...
        for asource in available_sources:
            if source == asource[0]:
                ...
                for row in file7:
                    ...
                    #LofarSigRA = float(row_cols[1])  ## Sigma RA from file
                    #LofarSigDEC = float(row_cols[2])  ## Sigma DEC from file
...
def HostDistAlongLine(source_list, available_sources):
    ...
    """
    ***
    NOT NEEDED IN MEERKAT AND WILL NOT WORK
    ***
...
def NClosestDistances(source_list, available_sources, lofar_table, n):
    ...
    for source in source_list:
        ...
        file5 = open(RLF.LDists %source, 'r') # Ldist for linear or Rdist for error corrected
